...
export default async function handler(
  ...
  let c1_green = 256 * (0.4 * danceability[2] + 0.2 * speechiness[2] + 0.2 * instrumentalness[2] + 0.2 * acousticness[2])
  let c2_green = 256 * (0.4 * danceability[1] + 0.2 * speechiness[1] + 0.2 * instrumentalness[1] + 0.2 * acousticness[1])
  ...
  let c1_blue = 256 * (0.7 * mode[2] + 0.1 * tempo[2] + 0.1 * key[2] + 0.1 * time_signature[2])
  let c2_blue = 256 * (0.7 * mode[1] + 0.1 * tempo[1] + 0.1 * key[1] + 0.1 * time_signature[1])
  ...
  c1_red = Math.min(1.3 * c1_red, 255)
  c1_green = c1_green
  c1_blue = 0.4 * c1_blue
